...
export const BUILTIN_STATUS_METRICS: MetricDefinitionMap = {
  ...
  ohead: { type: 'num', label: 'Mux overhead', freg: '*', unit: 'pc' },
  ohead_pc: { type: 'num', label: 'Per-packet overhead', freg: '*' },
  twnd: { type: 'num', label: 'Stats time window', freg: '*', unit: 'ms' },
  wait: { type: 'bool', label: 'Waiting', freg: '*' },
