  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          {currentTool.toUpperCase()} : {currentToolStyles.effectiveLevel.toUpperCase()} ({visibleLogsCount})
        </Badge>
        </Button>
      </DropdownMenuTrigger>
      <DropdownMenuContent align="end" className="w-40 bg-gray-950 h-64 overflow-y-auto border-transparent">
