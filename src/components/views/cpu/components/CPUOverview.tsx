  ...
  return (
    <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
      <Card className="bg-black/80">
        ...
        <CardContent>
          <div className="flex items-baseline">
            <span className="text-2xl font-semibold">{isLoading ? "..." : formatPercent(cpuUsage)}</span>
      ...
      <Card className="bg-black/80">
        ...
        <CardContent>
          <div className="flex items-baseline">
            <span className="text-2xl font-semibold">{isLoading ? "..." : formatBytes(memoryProcess).toString()}</span>
      ...
      <Card className="bg-black/80">
        ...
        <CardContent>
          <div className="flex items-baseline">
            <span className="text-2xl font-semibold">{isLoading ? "..." : totalCores}</span>
