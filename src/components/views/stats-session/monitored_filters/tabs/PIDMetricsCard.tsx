  ...
  ({
    ...
    return (
      ...
      >
        ...
        {/* KPIs — identiques input et output */}
        <div className="grid grid-cols-5 gap-2 px-3 py-2 text-center">
          <div>
            <div
          ...
          <div>
            <div
              className={`${metricValueFont} font-medium text-info tabular-nums`}
            >
              {formatPidCount(pid.nb_pck_queued)}
            </div>
            <div className={`${metricLabelFont} text-muted-foreground`}>
              Queued
            </div>
          ...
          <div>
            <div
              className={`${metricValueFont} font-medium text-info tabular-nums`}
            >
              {formatPidCount(pid.stats?.nb_processed)}
            </div>
            <div className={`${metricLabelFont} text-muted-foreground`}>
              Packets
            </div>
          ...
          <div>
            ...
            >
              {formatPidPeak(pid.stats?.max_process_time)}
            </div>
            <div className={`${metricLabelFont} text-muted-foreground`}>
              Peak
            </div>
