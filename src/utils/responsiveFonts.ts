...
/**
 * Metric value font size (main numbers)
 * Mobile: text-xs (12px) → Tablet: md:text-sm (14px) → Desktop: lg:text-sm (14px)
 */
export const metricValueFont = 'text-xs md:text-sm lg:text-sm';
 ...
 * Mobile: text-sm (14px) → Tablet: md:text-base (16px) → Desktop: lg:text-base (16px)
 */
export const headerFont = 'text-sm md:text-base lg:text-base';
